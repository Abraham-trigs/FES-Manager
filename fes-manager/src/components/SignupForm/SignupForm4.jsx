  ...
  return (
    <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-6 text-center">
      ...
      <div>
        ...
        {/* Profile Picture */}
        <div className="mb-4">
          <label htmlFor="profilePicture" className="block text-sm font-medium text-gray-700">Upload Profile Picture (Optional)</label>
          <input
            type="file"
        ...
        {(userData.accountType === "Organization" || userData.accountType === "Government") && (
          <div className="mb-4">
            <label htmlFor="idDocument" className="block text-sm font-medium text-gray-700">Upload ID or Registration Document (Required)</label>
            <input
              type="file"
